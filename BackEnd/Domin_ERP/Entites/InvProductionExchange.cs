...
[Table("inv_production_exchange")]
public partial class InvProductionExchange
{
    [Key]
    [Column("id")]
    ...
    [Column("inv_production_order_auto_serial")]
    public long? InvProductionOrderAutoSerial { get; set; }
    ...
    [InverseProperty("InvProductionExchange")]
    public virtual ICollection<InvProductionExchangeDetail> InvProductionExchangeDetails { get; set; } = new List<InvProductionExchangeDetail>();
}
