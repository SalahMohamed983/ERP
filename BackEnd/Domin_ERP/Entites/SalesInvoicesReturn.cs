...
[Table("sales_invoices_return")]
public partial class SalesInvoicesReturn
{
    [Key]
    [Column("id")]
    ...
    [InverseProperty("SalesInvoicesReturn")]
    public virtual ICollection<SalesInvoicesReturnDetail> SalesInvoicesReturnDetails { get; set; } = new List<SalesInvoicesReturnDetail>();
}
