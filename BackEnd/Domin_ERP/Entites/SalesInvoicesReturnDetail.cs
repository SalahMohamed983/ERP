...
public partial class SalesInvoicesReturnDetail
{
    [Key]
    [Column("id")]
    ...
    public long SalesInvoicesReturnId { get; set; }
    ...
    [ForeignKey("SalesInvoicesReturnId")]
    [InverseProperty("SalesInvoicesReturnDetails")]
    public virtual SalesInvoicesReturn SalesInvoicesReturn { get; set; } = null!;
}
