...
[Table("inv_production_receive")]
public partial class InvProductionReceive
{
    [Key]
    [Column("id")]
    ...
    [InverseProperty("InvProductionReceive")]
    public virtual ICollection<InvProductionReceiveDetail> InvProductionReceiveDetails { get; set; } = new List<InvProductionReceiveDetail>();
}
