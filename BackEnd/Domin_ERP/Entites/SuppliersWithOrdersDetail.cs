...
[Table("suppliers_with_orders_details")]
public partial class SuppliersWithOrdersDetail
{
    [Key]
    [Column("id")]
    public long Id { get; set; }

    [Column("suppliers_with_order_id")]
    public long SuppliersWithOrderId { get; set; }

    [Column("suppliers_with_orders_auto_serial")]
    public long SuppliersWithOrdersAutoSerial { get; set; }
